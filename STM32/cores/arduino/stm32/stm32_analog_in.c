...
#ifndef ADC_CLOCK_SYNC_PCLK_DIV2
#define ADC_CLOCK_SYNC_PCLK_DIV2 ADC_CLOCKPRESCALER_PCLK_DIV2
#endif

#ifndef ADC_RESOLUTION_10B
#define ADC_RESOLUTION_10B ADC_RESOLUTION10b
#endif
...
int analogRead(uint8_t pin) {
    ...
    if (handle.Instance == NULL) {
        ...
        handle.Init.EOCSelection = ADC_EOC_SINGLE_CONV;
            ...
            handle.Init.Resolution = ADC_RESOLUTION10b;
        #endif
