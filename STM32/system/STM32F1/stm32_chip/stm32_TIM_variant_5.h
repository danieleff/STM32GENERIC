...
const stm32_tim_pin_list_type chip_tim12 [] = {
    { TIM12 ,GPIOB, GPIO_PIN_12 ,TIM_CH1    , AF__HAL_AFIO_REMAP_TIM12_ENABLE}, 
    { TIM12 ,GPIOC, GPIO_PIN_4  ,TIM_CH1    , AF__HAL_AFIO_REMAP_TIM12_DISABLE}, 
    { TIM12 ,GPIOB, GPIO_PIN_13 ,TIM_CH2    , AF__HAL_AFIO_REMAP_TIM12_ENABLE}, 
    { TIM12 ,GPIOC, GPIO_PIN_5  ,TIM_CH2    , AF__HAL_AFIO_REMAP_TIM12_DISABLE}, 
}; 

const stm32_tim_pin_list_type chip_tim13 [] = {
    { TIM13 ,GPIOB, GPIO_PIN_0  ,TIM_CH1    , AF__HAL_AFIO_REMAP_TIM13_ENABLE}, 
    { TIM13 ,GPIOC, GPIO_PIN_8  ,TIM_CH1    , AF__HAL_AFIO_REMAP_TIM13_DISABLE}, 
}; 

const stm32_tim_pin_list_type chip_tim14 [] = {
    { TIM14 ,GPIOB, GPIO_PIN_1  ,TIM_CH1    , AF__HAL_AFIO_REMAP_TIM14_ENABLE}, 
    { TIM14 ,GPIOC, GPIO_PIN_9  ,TIM_CH1    , AF__HAL_AFIO_REMAP_TIM14_DISABLE}, 
}; 
