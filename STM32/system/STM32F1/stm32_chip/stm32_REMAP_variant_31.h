...
#ifdef __HAL_AFIO_REMAP_I2S3_DISABLE
static void AF__HAL_AFIO_REMAP_I2S3_DISABLE(void) { __HAL_AFIO_REMAP_I2S3_DISABLE(); }
#else
static void AF__HAL_AFIO_REMAP_I2S3_DISABLE(void) { AF_NO_REMAP(); }
#endif
