...
//UART10
    { UART10, GPIOE, GPIO_PIN_2  , GPIO_AF11_UART10}, 
    { UART10, GPIOG, GPIO_PIN_11 , GPIO_AF11_UART10}, 
//UART4
    { UART4 , GPIOA, GPIO_PIN_1  , GPIO_AF8_UART4 }, 
    { UART4 , GPIOA, GPIO_PIN_11 , GPIO_AF11_UART4}, 
    { UART4 , GPIOC, GPIO_PIN_11 , GPIO_AF8_UART4 }, 
    { UART4 , GPIOD, GPIO_PIN_0  , GPIO_AF11_UART4}, 
//UART5
...
//UART8
    ...
    { UART8 , GPIOF, GPIO_PIN_8  , GPIO_AF8_UART8 }, 
//UART9
    { UART9 , GPIOD, GPIO_PIN_14 , GPIO_AF11_UART9}, 
    { UART9 , GPIOG, GPIO_PIN_0  , GPIO_AF11_UART9}, 
//USART1
...
//UART10
    { UART10, GPIOE, GPIO_PIN_3  , GPIO_AF11_UART10}, 
    { UART10, GPIOG, GPIO_PIN_12 , GPIO_AF11_UART10}, 
//UART4
    { UART4 , GPIOA, GPIO_PIN_0  , GPIO_AF8_UART4 }, 
    { UART4 , GPIOA, GPIO_PIN_12 , GPIO_AF11_UART4}, 
    { UART4 , GPIOD, GPIO_PIN_1  , GPIO_AF11_UART4}, 
    { UART4 , GPIOD, GPIO_PIN_10 , GPIO_AF8_UART4 }, 
//UART5
...
//UART8
    ...
    { UART8 , GPIOF, GPIO_PIN_9  , GPIO_AF8_UART8 }, 
//UART9
    { UART9 , GPIOD, GPIO_PIN_15 , GPIO_AF11_UART9}, 
    { UART9 , GPIOG, GPIO_PIN_1  , GPIO_AF11_UART9}, 
//USART1
