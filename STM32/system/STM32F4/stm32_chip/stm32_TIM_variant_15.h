...
const stm32_tim_pin_list_type chip_tim1 [] = {
    ...
    { TIM1  ,GPIOF, GPIO_PIN_10 ,TIM_ETR    , GPIO_AF1_TIM1  }, 
}; 
...
const stm32_tim_pin_list_type chip_tim5 [] = {
    ...
    { TIM5  ,GPIOF, GPIO_PIN_3  ,TIM_CH1    , GPIO_AF2_TIM5  }, 
    { TIM5  ,GPIOA, GPIO_PIN_1  ,TIM_CH2    , GPIO_AF2_TIM5  }, 
    { TIM5  ,GPIOF, GPIO_PIN_4  ,TIM_CH2    , GPIO_AF2_TIM5  }, 
    { TIM5  ,GPIOA, GPIO_PIN_2  ,TIM_CH3    , GPIO_AF2_TIM5  }, 
    { TIM5  ,GPIOF, GPIO_PIN_5  ,TIM_CH3    , GPIO_AF2_TIM5  }, 
    { TIM5  ,GPIOA, GPIO_PIN_3  ,TIM_CH4    , GPIO_AF2_TIM5  }, 
    { TIM5  ,GPIOF, GPIO_PIN_10 ,TIM_CH4    , GPIO_AF2_TIM5  }, 
}; 
...
const stm32_tim_pin_list_type chip_tim8 [] = {
    ...
    { TIM8  ,GPIOF, GPIO_PIN_12 ,TIM_BKIN   , GPIO_AF3_TIM8  }, 
    ...
    { TIM8  ,GPIOF, GPIO_PIN_11 ,TIM_ETR    , GPIO_AF3_TIM8  }, 
}; 
