...
const stm32_tim_pin_list_type chip_tim5 [] = {
    ...
    { TIM5  ,GPIOC, GPIO_PIN_10 ,TIM_CH2    , GPIO_AF2_TIM5  }, 
    { TIM5  ,GPIOA, GPIO_PIN_2  ,TIM_CH3    , GPIO_AF2_TIM5  }, 
    { TIM5  ,GPIOC, GPIO_PIN_11 ,TIM_CH3    , GPIO_AF2_TIM5  }, 
    { TIM5  ,GPIOA, GPIO_PIN_3  ,TIM_CH4    , GPIO_AF2_TIM5  }, 
    { TIM5  ,GPIOB, GPIO_PIN_11 ,TIM_CH4    , GPIO_AF2_TIM5  }, 
}; 
...
const stm32_tim_pin_list_type chip_tim9 [] = {
    ...
    { TIM9  ,GPIOC, GPIO_PIN_4  ,TIM_CH1    , GPIO_AF3_TIM9  }, 
    { TIM9  ,GPIOA, GPIO_PIN_3  ,TIM_CH2    , GPIO_AF3_TIM9  }, 
    { TIM9  ,GPIOC, GPIO_PIN_5  ,TIM_CH2    , GPIO_AF3_TIM9  }, 
}; 
...
const stm32_tim_pin_list_type chip_tim11 [] = {
    ...
    { TIM11 ,GPIOC, GPIO_PIN_12 ,TIM_CH1    , GPIO_AF3_TIM11 }, 
}; 
