...
const stm32_tim_pin_list_type chip_tim5 [] = {
    ...
    { TIM5  ,GPIOF, GPIO_PIN_6  ,TIM_ETR    , GPIO_AF2_TIM5  }, 
}; 
...
const stm32_tim_pin_list_type chip_tim9 [] = {
    ...
    { TIM9  ,GPIOD, GPIO_PIN_0  ,TIM_CH1    , GPIO_AF3_TIM9  }, 
    ...
    { TIM9  ,GPIOD, GPIO_PIN_7  ,TIM_CH2    , GPIO_AF3_TIM9  }, 
}; 
...
const stm32_tim_pin_list_type chip_tim10 [] = {
    ...
    { TIM10 ,GPIOE, GPIO_PIN_0  ,TIM_CH1    , GPIO_AF3_TIM10 }, 
}; 
...
const stm32_tim_pin_list_type chip_tim11 [] = {
    ...
    { TIM11 ,GPIOE, GPIO_PIN_1  ,TIM_CH1    , GPIO_AF3_TIM11 }, 
}; 
