...
//SPI1
    ...
    { SPI1  , GPIOE, GPIO_PIN_14 , GPIO_AF2_SPI1  }, 
//SPI2
    { SPI2  , GPIOB, GPIO_PIN_14 , GPIO_AF0_SPI2  }, 
    { SPI2  , GPIOC, GPIO_PIN_2  , GPIO_AF2_SPI2  }, 
    { SPI2  , GPIOD, GPIO_PIN_3  , GPIO_AF2_SPI2  }, 
}; 
...
//SPI1
    ...
    { SPI1  , GPIOE, GPIO_PIN_15 , GPIO_AF2_SPI1  }, 
//SPI2
    { SPI2  , GPIOB, GPIO_PIN_15 , GPIO_AF0_SPI2  }, 
    { SPI2  , GPIOC, GPIO_PIN_3  , GPIO_AF2_SPI2  }, 
...
//SPI1
    ...
    { SPI1  , GPIOE, GPIO_PIN_12 , GPIO_AF2_SPI1  }, 
//SPI2
    { SPI2  , GPIOB, GPIO_PIN_9  , GPIO_AF5_SPI2  }, 
    { SPI2  , GPIOB, GPIO_PIN_12 , GPIO_AF0_SPI2  }, 
    { SPI2  , GPIOD, GPIO_PIN_0  , GPIO_AF1_SPI2  }, 
}; 
...
//SPI1
    ...
    { SPI1  , GPIOE, GPIO_PIN_13 , GPIO_AF2_SPI1  }, 
//SPI2
