...
const stm32_tim_pin_list_type chip_tim2 [] = {
    ...
    { TIM2  ,GPIOE, GPIO_PIN_9  ,TIM_ETR    , GPIO_AF2_TIM2  }, 
}; 
...
const stm32_tim_pin_list_type chip_tim3 [] = {
    ...
    { TIM3  ,GPIOB, GPIO_PIN_5  ,TIM_CH2    , GPIO_AF4_TIM3  }, 
